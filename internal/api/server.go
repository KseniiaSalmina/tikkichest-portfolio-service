...
type Connector interface {
	GetAllPortfolios(ctx context.Context, limit int, offset int, filter postgresql.PortfoliosFilter) ([]models.Portfolio, error)
	...
	GetAllCategories(ctx context.Context, limit int, offset int) ([]models.Category, error)
	GetAllCraftsByPortfolioID(ctx context.Context, portfolioID int, limit int, offset int) ([]models.Craft, error)
	...
	GetAllCraftsByTagID(ctx context.Context, tagID int, limit int, offset int) ([]models.Craft, error)
